...
/// <summary>
/// Defines an asynchronous preprocessor that executes before a dispatch-able type is handled.
/// </summary>
...
{
    /// <summary>
    /// Performs an asynchronous task before the dispatch-able object is handled.
    /// </summary>
...
/// <summary>
/// Defines an asynchronous preprocessor that executes before a request is handled.
/// </summary>
...
{
    /// <summary>
    /// Performs an asynchronous task before the request is handled.
    /// </summary>
