...
/// <summary>
/// Defines an asynchronous postprocessor that executes after a dispatch-able type is handled.
/// </summary>
/// <typeparam name="TDispatch">
/// The type of the dispatch-able object (e.g., <see cref="INotification"/> or <see cref="IFireAndForget"/>).
/// </typeparam>
public interface IPostProcessor<TDispatch> where TDispatch : IDispatch
{
    /// <summary>
    /// Performs an asynchronous task after the dispatch-able object has been handled.
    /// </summary>
    /// <param name="dispatch">The dispatch-able object that was processed.</param>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    Task Process(TDispatch dispatch, CancellationToken cancellationToken);
}

/// <summary>
/// Defines an asynchronous postprocessor that executes after a request is handled.
/// </summary>
...
{
    /// <summary>
    /// Performs an asynchronous task after the request has been handled.
    /// </summary>
